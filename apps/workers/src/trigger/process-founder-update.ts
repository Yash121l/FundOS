...
// Also exported for synchronous use when Trigger.dev is not configured
export async function runAnalysis(payload: ProcessFounderUpdatePayload) {
  ...
  await writeAIAuditLog({
    ...
    output: {
      ...
      founderTone: analysis.founderTone,
    },
    createdAt: new Date(),
  })
